package me.gurasic.incremental.GUIs.SuperPrestigeGUI.SuperPrestigeUpgrades.SP8;
...
public class Incredible_Findings extends AbstractItem {

    private UUID playerUUID;

    public Incredible_Findings(UUID playerUUID) {
