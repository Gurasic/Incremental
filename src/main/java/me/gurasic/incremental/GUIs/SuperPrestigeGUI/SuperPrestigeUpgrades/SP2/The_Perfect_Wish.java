package me.gurasic.incremental.GUIs.SuperPrestigeGUI.SuperPrestigeUpgrades.SP2;
...
public class The_Perfect_Wish extends AbstractItem {

    private UUID playerUUID;

    public The_Perfect_Wish(UUID playerUUID) {
