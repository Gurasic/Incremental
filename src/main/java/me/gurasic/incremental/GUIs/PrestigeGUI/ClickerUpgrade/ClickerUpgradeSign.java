...
public class ClickerUpgradeSign extends AutoUpdateItem {

    private UUID playerUUID;

    public ClickerUpgradeSign(int period, Supplier<? extends ItemProvider> builderSupplier, UUID playerUUID) {
