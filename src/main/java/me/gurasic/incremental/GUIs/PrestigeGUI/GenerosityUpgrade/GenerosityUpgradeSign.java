...
public class GenerosityUpgradeSign extends AutoUpdateItem {

    private UUID playerUUID;

    public GenerosityUpgradeSign(int period, Supplier<? extends ItemProvider> builderSupplier, UUID playerUUID) {
