...
public class WishingUpgradeSign extends AutoUpdateItem {

    private UUID playerUUID;

    public WishingUpgradeSign(int period, Supplier<? extends ItemProvider> builderSupplier, UUID playerUUID) {
